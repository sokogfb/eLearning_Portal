							...
							<div class="span12">
								<table cellpadding="0" cellspacing="0" class="table" id="">
									...
									<tbody>
										...
										<?php
										$query = mysqli_query($link, "select * FROM assignment where class_id = '$get_id' and teacher_id = '$session_id' order by fdatein DESC ") or die(mysqli_error($link));
											...
											<tr>
												...
												<td width="150">
													<form method="post" action="view_submit_assignment.php<?php echo '?id=' . $get_id ?>&<?php echo 'post_id=' . $id ?>">
														...
														<button data-placement="bottom" id="<?php echo $id; ?>view" class="btn btn-info"><i class="icon-folder-open-alt icon-large"></i></button>
													...
													<?php } ?>
													<a data-placement="bottom" title="Delete" id="<?php echo $id; ?>remove" class="btn btn-danger" href="#<?php echo $id; ?>" data-toggle="modal"><i class="icon-remove icon-large"></i></a>
