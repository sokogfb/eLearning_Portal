							...
							<div id="" class="muted pull-left">
								<div class="tabs">
									<ul class="nav nav-tabs">
										<li class="active"><a href="student_message.php"><i class="icon-inbox"></i>Inbox</a></li>
										<li class=""><a href="sent_message_student.php"><i class="icon-envelope-alt"></i>Sent items </a></li>
									</ul>
								</div>
							</div>
						</div>
