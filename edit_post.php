				...
				<div class="row-fluid">
					...
					<div id="block_bg" class="block">
						...
						<div class="block-content collapse in">
							<div class="span12">
								<a href="announcements.php<?php echo '?id=' . $get_id; ?>"><i class="icon-arrow-left icon-large"></i> Kthehu</a>
								<br>
								<br>
								<form method="post">
									<?php
							...
							if (isset($_POST['post'])) {
								...
								mysqli_query($link, "update teacher_class_announcements  set content = '$content' where teacher_class_announcements_id = '$id' ") or die(mysqli_error($link));
								?>
								<script>
