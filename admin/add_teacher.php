...
<div class="row-fluid">
  ...
  <div class="block">
    <div class="navbar navbar-inner block-header">
      <div class="muted pull-left">Create new teacher</div>
    </div>
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <select name="department" class="" required>
                <option></option>
                <?php
                $query = mysqli_query($link, "select * from department order by department_name");
...
if (isset($_POST['save'])) {
  ...
  mysqli_query($link, "insert into teacher (firstname,lastname,location,department_id)
