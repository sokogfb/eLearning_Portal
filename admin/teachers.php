                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($teacher_query)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="50"><a href="edit_teacher.php<?php echo '?id=' . $id; ?>" class="btn btn-info"><i class="icon-pencil"></i></a></td>
                                                    ...
                                                    <?php } else { ?>
                                                        <td width="120"><a href="edit_teacher.php<?php echo '?id=' . $id; ?>" class="btn btn-info"><i class="icon-check"></i> Activated</a></td>
                                                    <?php } ?>
                                                </tr>
                                            <?php } ?>
