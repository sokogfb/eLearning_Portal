...
<div class="row-fluid">
  <a href="students.php" class="btn btn-info"><i class="icon-plus-sign icon-large"></i> Create new student</a>
  <!-- block -->
  <div class="block">
    ...
    <div class="block-content collapse in">
      <?php
      $query = mysqli_query($link, "select * from student LEFT JOIN class ON class.class_id = student.class_id where student_id = '$get_id'") or die(mysqli_error($link));
      ...
      <div class="span12">
        <form method="post">
          ...
          <div class="control-group">
            <div class="controls">
              <input name="un" value="<?php echo $row['username']; ?>" class="input focused" id="focusedInput" type="text" placeholder="ID" required>
            </div>
          </div>
...
if (isset($_POST['update'])) {
  ...
  mysqli_query($link, "update student set username = '$un' , firstname ='$fn' , lastname = '$ln' , class_id = '$cys' where student_id = '$get_id' ") or die(mysqli_error($link));
