				...
				<div class="row-fluid">
					...
					<div id="block_bg" class="block">
						<div class="navbar navbar-inner block-header">
							<div class="muted pull-left">List of academic years</div>
						</div>
							...
							<div class="span12">
								<form action="delete_sy.php" method="post">
									<table cellpadding="0" cellspacing="0" class="table" id="example">
										...
										<tbody>
											<?php
											$user_query = mysqli_query($link, "select * from school_year") or die(mysqli_error($link));
											while ($row = mysqli_fetch_array($user_query)) {
												...
												<tr>
													...
													<td width="40">
														<a href="edit_user.php<?php echo '?id=' . $id; ?>" data-toggle="modal" class="btn btn-info"><i class="icon-pencil icon-large"></i></a>
													</td>
												</tr>
											<?php } ?>
										</tbody>
