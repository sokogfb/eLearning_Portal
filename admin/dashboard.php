                    ...
                    <div id="block_bg" class="block">
                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                ...
                                <?php
                                $query_reg_teacher = mysqli_query($link, "select * from teacher where teacher_status = 'Registered' ") or die(mysqli_error($link));
                                ...
                                <?php
                                $query_teacher = mysqli_query($link, "select * from teacher") or die(mysqli_error($link));
                                ...
                                <?php
                                $query_student = mysqli_query($link, "select * from student where status='Registered'") or die(mysqli_error($link));
                                ...
                                <?php
                                $query_student = mysqli_query($link, "select * from student") or die(mysqli_error($link));
                                $count_student = mysqli_num_rows($query_student);
                                ?>
                                ...
                                <?php
                                $query_class = mysqli_query($link, "select * from class") or die(mysqli_error($link));
                                $count_class = mysqli_num_rows($query_class);
                                ?>

                                <div class="span3">
                                    <div class="chart" data-percent="<?php echo $count_class; ?>"><?php echo $count_class; ?></div>
                                    <div class="chart-bottom-heading"><strong>Program of study </strong>

                                    </div>
                                </div>

                                <?php
                                $query_file = mysqli_query($link, "select * from files") or die(mysqli_error($link));
                                $count_file = mysqli_num_rows($query_file);
                                ?>

                                <div class="span3">
                                    <div class="chart" data-percent="<?php echo $count_file; ?>"><?php echo $count_file; ?></div>
                                    <div class="chart-bottom-heading"><strong>Downloads</strong>

                                    </div>
                                </div>

                                <?php
                                $query_subject = mysqli_query($link, "select * from subject") or die(mysqli_error($link));
