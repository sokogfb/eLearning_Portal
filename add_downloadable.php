						...
						<div class="block-content collapse in">
							<div class="span4">
								<form class="" id="add_downloadble" method="post" enctype="multipart/form-data" name="upload">
									...
									<div class="control-group">
										<div class="controls">
											<textarea Placeholder="Description" id="assigntextare" name="desc" required></textarea>
										</div>
									</div>
									<script>
										jQuery(document).ready(function($) {
											$("#add_downloadble").submit(function(e) {
												$.jGrowl("Uploading, please wait...", {
													sticky: true
												});
												e.preventDefault();
												var _this = $(e.target);
							...
							<div class="span8">
								<div class="alert alert-info">Upload the file to one or more classes</div>
								<div class="pull-left">
								...
								<table cellpadding="0" cellspacing="0" class="table" id="">
									...
									<tbody>
										...
										where teacher_id = '$session_id' and school_year = '$school_year' ") or die(myi_error());
