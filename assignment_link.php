<div class="span3" id="sidebar">
	...
	<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
		...
		<li class=""><a href="my_students.php<?php echo '?id=' . $get_id; ?>"><i class="icon-group"></i>&nbsp; Sudents</a></li>
		...
		<li class="active"><a href="assignment.php<?php echo '?id=' . $get_id; ?>"><i class="icon-book"></i>&nbsp;Assignment</a></li>
