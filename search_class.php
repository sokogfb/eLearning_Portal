			...
			<div class="span6" id="content">
				<div class="row-fluid">
					...
					<ul class="breadcrumb">
						...
						$school_year_query = mysqli_query($link, "select * from school_year where  school_year = '$sy'") or die(mysqli_error($link));
						$school_year_query_row = mysqli_fetch_array($school_year_query);
						$school_year = $school_year_query_row['school_year'];
						?>
						<li><a href="#"><b>Classes</b></a><span class="divider">/</span></li>
								...
								<ul id="da-thumbs" class="da-thumbs">
									...
									while ($row = mysqli_fetch_array($query)) {
										...
										<li>
											...
											<a href="#<?php echo $id; ?>" data-toggle="modal"><i class="icon-trash"></i> Fshi</a>
