					...
					<div id="block_bg" class="block">
						...
						<div class="block-content collapse in">
							...
							if (isset($_POST['post'])) {
								...
								mysqli_query($link, "insert into teacher_class_announcements (teacher_class_id,teacher_id,content,date) values('$get_id','$session_id','$content',NOW())") or die(mysqli_error($link));
								mysqli_query($link, "insert into notification (teacher_class_id,notification,date_of_notification,link) value('$get_id','Add Annoucements',NOW(),'announcements_student.php')") or die(mysqli_error($link));
								?>
								<script>
			...
			<div class="span4 row-fluid">
				...
				<div id="block_bg" class="block">
					...
					<div class="block-content collapse in">
						<div class="span12">
							<?php
							$query_announcement = mysqli_query($link, "select * from teacher_class_announcements
					...
					$('.remove').click(function() {
						...
						$.ajax({
							...
							success: function(html) {
								...
								$('#' + id).modal('hide');
								$.jGrowl("Notification successfully deleted", {
									header: 'Data Delete'
								});
