                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
					    <!-- breadcrumb -->	
									<ul class="breadcrumb">
										<?php
										$school_year_query = mysqli_query($link, "select * from school_year order by school_year DESC")or die(mysqli_error($link));
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<a data-toggle="modal" href="#backup_delete" id="delete"  class="btn btn-info" name=""><i class="icon-move icon-large"></i> Move</a>
