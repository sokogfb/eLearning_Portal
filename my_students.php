			...
			<div class="span9" id="content">
				<div class="row-fluid">
					<div class="pull-right">
						...
						<a onclick="window.open('print_student.php<?php echo '?id=' . $get_id; ?>')" class="btn btn-info"><i class="icon-list"></i> List of students</a>
					</div>
					...
					<div id="block_bg" class="block">
						<div class="navbar navbar-inner block-header">
							<div id="" class="muted pull-right">
								<?php
								$my_student = mysqli_query($link, "SELECT * FROM teacher_class_student
														LEFT JOIN student ON student.student_id = teacher_class_student.student_id 
														INNER JOIN class ON class.class_id = student.class_id where teacher_class_id = '$get_id' order by lastname ") or die(mysqli_error($link));
								...
								<ul id="da-thumbs" class="da-thumbs">
									...
									while ($row = mysqli_fetch_array($my_student)) {
										...
										<li id="del<?php echo $id; ?>">
											...
											<a class="danger" href="#<?php echo $id; ?>" data-toggle="modal"><i class="icon-trash"></i> Remove</a>
										</li>
										...
										$('.remove').click(function() {
											...
											$.ajax({
												...
												success: function(html) {
													...
													$('#' + id).modal('hide');
													$.jGrowl("Your Student is Successfully Removed", {
