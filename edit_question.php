						...
						<div class="block-content collapse in">
							<div class="span12">
								...
								$query = mysqli_query($link, "select * FROM quiz_question
										...
										where quiz_id = '$get_id' and quiz_question_id = '$quiz_question_id'  order by date_added DESC ") or die(mysqli_error($link));
								...
								<form class="form-horizontal" method="post">
									...
									<div class="control-group">
										...
										<div class="controls">
											<div id="opt11">
												<?php
												$sqlz = mysqli_query($link, "SELECT * FROM answers WHERE q_id = " . $_GET['edit'] . "");
