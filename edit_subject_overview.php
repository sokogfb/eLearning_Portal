                     ...
                     <div class="row-fluid">
					  <!-- breadcrumb -->
					     ...
					     <ul class="breadcrumb">
							...
							<li><a href="#"><b>Information about course</b></a></li>
						</ul>
						 <!-- end breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
								...
								<a href="subject_overview.php<?php echo '?id='.$get_id; ?>" class="btn btn-info"><i class="icon-arrow-left"></i> Back</a>
								</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
								<?php 
								$subject_query = mysqli_query($link, "select * from class_subject_overview where  class_subject_overview_id  = '$subject_id'")or die(mysqli_error($link));
								...
								?>
										...
										mysqli_query($link, "update class_subject_overview set content = '$content' where class_subject_overview_id = '$subject_id'")or die(mysqli_error($link));
										?>
										<script>
