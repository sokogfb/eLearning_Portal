	...
	if ($count > 0) {
		while ($row = mysqli_fetch_array($query)) {
			...
			<li id="del<?php echo $id; ?>">
				...
				<a class="danger" href="#<?php echo $id; ?>" data-toggle="modal"><i class="icon-trash"></i> Delete </a>

			</li>
			<?php include("delete_class_modal.php"); ?>
		<?php }
} else { ?>
		<div class="alert alert-info"><i class="icon-info-sign"></i> There are no data to show.</div>
	<?php  } ?>
</ul>