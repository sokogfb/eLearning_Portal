...
<div class="block">
	<div class="navbar navbar-inner block-header">
		<div id="" class="muted pull-left">
			<h4><i class="icon-plus-sign"></i> Add new class </h4>
		</div>
	</div>
		...
		<div class="span12">
			<form method="post" id="add_class">
				...
				<div class="control-group">
					...
					<div class="controls">
						<?php
						$query = mysqli_query($link, "select * from school_year order by school_year DESC");
						$row = mysqli_fetch_array($query);
						?>
						<input id="" class="span5" type="text" class="" name="school_year" value="">
					</div>
				</div>
				<div class="control-group">
					<div class="controls">
						<button name="save" class="btn btn-info"><i class="icon-save"></i> Save</button>
					</div>
				</div>
			</form>
