				...
				<div class="row-fluid">
					...
					<div id="block_bg" class="block">
						...
						<div class="block-content collapse in">
							<div class="span12">
								<?php
								$query1 = mysqli_query($link, "select * FROM assignment where assignment_id = '$post_id'") or die(mysqli_error($link));
								$row1 = mysqli_fetch_array($query1);

								?>
								<div class="alert alert-info">Assignment: <?php echo $row1['fname']; ?></div>
								...
								<div id="">
									...
									<table cellpadding="0" cellspacing="0"  class="table" id="">
										...
										<tbody>
											...
											<?php
											$query = mysqli_query($link, "select * FROM student_assignment 
										LEFT JOIN student on student.student_id  = student_assignment.student_id
										where assignment_id = '$post_id'  order by assignment_fdatein DESC") or die(mysqli_error($link));
												...
												<tr>
													...
													<td width="140">
														<form method="post" action="save_grade.php">
															...
															<button name="save" class="btn btn-info" id="btn_s"><i class="icon-save"></i> Save</button>
														</form>
													</td>
												</tr>
